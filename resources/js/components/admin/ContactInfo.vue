<template>
  <div>
    <div class="border rounded-md p-3 px-4" v-if="ticketDetails !== null">
      <div
        :class="[
    ...
    <div class="border rounded-md my-5 p-3 px-4" v-if="ticketDetails && ticketDetails.user">
      <div
        :class="[
          isLightColor ? 'text-custom-700' : 'text-custom-500',
          'font-medium flex items-center gap-2',
      ...
      <div class="flex flex-col space-y-2 py-1 text-tiny">
        <div class="flex justify-between items-center">
          ...
          <h1 class="text-gray-500 max-w-36 capitalize truncate" v-tooltip="ticketDetails.user.name">
            {{ ticketDetails.user ? ticketDetails.user.name : "-" }}
          </h1>
        </div>
        <div class="flex justify-between items-center">
          <h1 class="font-medium">Email</h1>
          <h1 class="text-gray-500 max-w-40 truncate" v-tooltip="ticketDetails.user.email">
            {{ ticketDetails.user ? ticketDetails.user.email : "-" }}
          </h1>
        </div>
      </div>
    </div>
    <div
      class="my-5 border rounded-md p-3 px-4"
    ...
    >
      ...
      <hr class="my-2" />
      <div class="text-tiny flex space-y-2 py-1 justify-between items-center">
